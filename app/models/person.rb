class Person < ActiveRecord::Base
  ...
  has_and_belongs_to_many :vacancy_reviews, class_name: 'Vacancy', join_table: 'vacancy_reviewers', dependent: :restrict_with_error
  has_many :quotes, dependent: :restrict_with_error

  has_many :node_identities, as: :identity, dependent: :destroy, class_name: CloudBlueprint::Identity, dependent: :restrict_with_error
